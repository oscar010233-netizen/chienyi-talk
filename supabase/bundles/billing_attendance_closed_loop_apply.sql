...
-- Bundle: billing_attendance_closed_loop_apply.sql
-- Purpose: Write bundle for the billing/attendance closed loop: open-bag detail tables and attendance status values.
