...
-- Purpose: create the normalized billing/open-bag tables used by /billing.
-- Slim 5-table model (no actual_attendance, no payment_print_events):
-- actual attendance is read live from class_tasks + student_task_records.
