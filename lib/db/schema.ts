...
export const DB_TABLES: TableMeta[] = [
  ...
  { name: 'billing_fee_presets', group: '帳務', note: 'class_id nullable = 全域範本；book/misc/discount_rows 為 JSONB array', columns: ['id', 'tenant_id', 'class_id', 'name', 'tuition_amount', 'book_rows', 'misc_rows', 'discount_rows', 'is_default', 'created_at', 'updated_at'] },
