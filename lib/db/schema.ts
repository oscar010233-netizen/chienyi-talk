...
export const DB_TABLES: TableMeta[] = [
  ...
  { name: 'schedule_event_teachers', group: '配課表', note: '被 events 查詢 join，勿刪此表', columns: ['id', 'tenant_id', 'schedule_event_id', 'teacher_id', 'start_time', 'end_time', 'color', 'created_at', 'updated_at'] },
  { name: 'day_entries', group: '配課表', columns: ['id', 'tenant_id', 'schedule_day_id', 'type', 'person', 'content', 'done', 'notes', 'sort_order', 'created_at'] },
  ...
  { name: 'default_attendance', group: '帳務', columns: ['id', 'tenant_id', 'season_id', 'class_id', 'session_index', 'default_date', 'original_date', 'period_key', 'source', 'status', 'note', 'created_at', 'updated_at'] },
