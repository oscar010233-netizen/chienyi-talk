    ...
    <div className="grid gap-3 p-4 sm:grid-cols-2 md:p-6 xl:grid-cols-3">
      {classes.map(c => (
        <Link
          ...
          className="flex items-center gap-4 rounded-xl border border-border bg-white p-4 transition-colors hover:border-gold/40 hover:bg-gold/5"
        >
          <div className="grid size-12 shrink-0 place-items-center rounded-lg bg-gold/10 text-gold">
